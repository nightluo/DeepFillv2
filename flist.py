...
parser.add_argument('--folder_path', default='/mnt/data/luoyan/road/track/08', type=str,
                    help='The folder path')
parser.add_argument('--train_filename', default='/mnt/data/luoyan/road/track/data_flist/train_shuffled.flist', type=str,
                    help='The output filename.')
parser.add_argument('--validation_filename', default='/mnt/data/luoyan/road/track/data_flist/validation_shuffled.flist', type=str,
                    help='The output filename.')
